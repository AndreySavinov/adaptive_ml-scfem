%STOCH_TESTPROBLEMS setting up stochastic diffusion test problems (Windows version)
%
% NOTE:
% sn: example problem
%
...
if sn == 1
    ...
    system('copy .\test_problems\unit_rhs.m                            .\right_hand_side.m');
...
elseif sn == 3
    ...
    system('copy .\test_problems\one_peak_rhs.m                        .\right_hand_side.m');
...
elseif sn == 6
    % L-shaped domain (-1,1)^2\(-1,0]^2; Exponent of Eigel affine expansion; unit f(x,y)
    system('copy .\test_problems\exponent_trunc_affine.m               .\stochcol_diffusion_grad_and_coeff.m');
    system('copy .\test_problems\eigel_spatial_expansion_coeff.m       .\stochcol_diffusion_coeff_spatial_expansion.m');
    system('copy .\test_problems\eigel_spatial_expansion_grad_x1.m     .\stochcol_diffusion_grad_x1_spatial_expansion.m');
    system('copy .\test_problems\eigel_spatial_expansion_grad_x2.m     .\stochcol_diffusion_grad_x2_spatial_expansion.m');
...
elseif sn == 8
    ...
    system('copy .\test_problems\standard_trunc_affine.m              .\stochcol_diffusion_grad_and_coeff.m');
    system('copy .\test_problems\round_cookies9_expansion_coeff.m     .\stochcol_diffusion_coeff_spatial_expansion.m');
    system('copy .\test_problems\zero_grad_x1.m                       .\stochcol_diffusion_grad_x1_spatial_expansion.m');
    system('copy .\test_problems\zero_grad_x2.m                       .\stochcol_diffusion_grad_x2_spatial_expansion.m');
    system('copy .\test_problems\unit_rhs.m                           .\right_hand_side.m');
...
elseif sn == 9
    ...
    system('copy .\test_problems\standard_trunc_affine.m              .\stochcol_diffusion_grad_and_coeff.m');
    system('copy .\test_problems\square_cookies4_expansion_coeff.m    .\stochcol_diffusion_coeff_spatial_expansion.m');
    system('copy .\test_problems\zero_grad_x1.m                       .\stochcol_diffusion_grad_x1_spatial_expansion.m');
    system('copy .\test_problems\zero_grad_x2.m                       .\stochcol_diffusion_grad_x2_spatial_expansion.m');
    system('copy .\test_problems\central_burst_cookies4_rhs.m         .\right_hand_side.m');
...
elseif sn == 10
    ...
    system('copy .\test_problems\standard_trunc_affine.m              .\stochcol_diffusion_grad_and_coeff.m');
    system('copy .\test_problems\bachmayr_coeff.m                     .\stochcol_diffusion_coeff_spatial_expansion.m');
    system('copy .\test_problems\bachmayr_grad_x1.m                   .\stochcol_diffusion_grad_x1_spatial_expansion.m');
    system('copy .\test_problems\bachmayr_grad_x2.m                   .\stochcol_diffusion_grad_x2_spatial_expansion.m');
    system('copy .\test_problems\unit_rhs.m                           .\right_hand_side.m');
...
elseif sn == 11
    % Square domain (0,1)^2; Square cookies coeffs (9 square subdomains),
    % f(x,y) = 100*F_{\chi_F} (as in Feischl & Scaglioni)
    system('copy .\test_problems\standard_trunc_affine.m              .\stochcol_diffusion_grad_and_coeff.m');
    system('copy .\test_problems\square_cookies8_expansion_coeff.m    .\stochcol_diffusion_coeff_spatial_expansion.m');
    system('copy .\test_problems\zero_grad_x1.m                       .\stochcol_diffusion_grad_x1_spatial_expansion.m');
    system('copy .\test_problems\zero_grad_x2.m                       .\stochcol_diffusion_grad_x2_spatial_expansion.m');
    system('copy .\test_problems\central_burst_cookies8_rhs.m         .\right_hand_side.m');
