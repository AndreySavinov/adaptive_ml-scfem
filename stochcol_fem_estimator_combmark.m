function [errest, elerr, ederr, MMele, MMedge] = stochcol_fem_estimator_combmark(...
    pmethod, paras_fem_errest, paras_fem, paras_detail, x_gal, coord, ...
    aa, aax1, aax2, rhs_fun, tout)
%STOCHCOL_FEM_ESTIMATOR_COMBMARK spatial energy error estimator with marking
%
%   Latest update: AB; 30 November 2022
% Copyright (c) 2019 A. Bespalov, D. Silvester, F. Xu
